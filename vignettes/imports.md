...
For matching, connecting terms (`x`, `subsp.`, …) must be removed, while
...
Where the matched Falling Fruit types are displayed using the following
convention:
...
Once the match table is complete, apply the type assignments to the
original data:
